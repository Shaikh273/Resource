                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive table-hover">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>
                                <div><?php echo ('Medicine Name'); ?></div>
                            </th>

                            <th>
                                <div><?php echo ('Medicine Catogory'); ?></div>
                            </th>
                            ...
                            <th>
                                <div><?php echo ('Manufacturing Company'); ?></div>
                            </th>
                        ...
                        foreach ($medicines as $row) : ?>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="<?php echo base_url(); ?>index.php?pharmacist/manage_medicine/edit/<?php echo $row['medicine_id']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit'); ?>" class="btn btn-primary">

                                        <i class="icon-wrench"></i>

                                    </a>

                                    <a href="<?php echo base_url(); ?>index.php?pharmacist/manage_medicine/delete/<?php echo $row['medicine_id']; ?>" onclick="return confirm('delete?')" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Delete'); ?>" class="btn btn-danger">
