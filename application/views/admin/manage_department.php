                    ...
                    <tbody>
                        ...
                        foreach ($departments as $row) : ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo base_url(); ?>index.php?admin/manage_department/edit/<?php echo $row['department_id']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit'); ?>" class="btn btn-primary">
                                        <i class="icon-wrench"></i>
                                    </a>
                                    <a href="<?php echo base_url(); ?>index.php?admin/manage_department/delete/<?php echo $row['department_id']; ?>" onclick="return confirm('delete?')" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Delete'); ?>" class="btn btn-danger">
