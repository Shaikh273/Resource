                        ...
                        foreach ($laboratorists as $row) : ?>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="<?php echo base_url(); ?>index.php?admin/manage_laboratorist/edit/<?php echo $row['laboratorist_id']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit'); ?>" class="btn btn-primary">
