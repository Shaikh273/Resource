                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <div><?php echo ('Pharmacist Name'); ?></div>
                            </th>
                            <th>
                    ...
                    <tbody>
                        ...
                        foreach ($pharmacists as $row) : ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo base_url(); ?>index.php?admin/manage_pharmacist/edit/<?php echo $row['pharmacist_id']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit'); ?>" class="btn btn-primary">
                                        <i class="icon-wrench"></i>
                                    </a>
                                    <a href="<?php echo base_url(); ?>index.php?admin/manage_pharmacist/delete/<?php echo $row['pharmacist_id']; ?>" onclick="return confirm('delete?')" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Delete'); ?>" class="btn btn-danger">
