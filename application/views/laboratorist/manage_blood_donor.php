                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive table-hover">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>
                                <div><?php echo ('Blood Group'); ?></div>
                            </th>

                            <th>
                                <div><?php echo ('Last Donation Date'); ?></div>
                            </th>
                        ...
                        foreach ($blood_donors as $row) : ?>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="<?php echo base_url(); ?>index.php?laboratorist/manage_blood_donor/edit/<?php echo $row['blood_donor_id']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit'); ?>" class="btn btn-primary">

                                        <i class="icon-wrench"></i>

                                    </a>

                                    <a href="<?php echo base_url(); ?>index.php?laboratorist/manage_blood_donor/delete/<?php echo $row['blood_donor_id']; ?>" onclick="return confirm('delete?')" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Delete'); ?>" class="btn btn-danger">
