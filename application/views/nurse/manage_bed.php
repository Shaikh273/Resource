                        ...
                        foreach ($beds as $row) : ?>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="<?php echo base_url(); ?>index.php?nurse/manage_bed/edit/<?php echo $row['bed_id']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit'); ?>" class="btn btn-primary">

                                        <i class="icon-wrench"></i>

                                    </a>

                                    <a href="<?php echo base_url(); ?>index.php?nurse/manage_bed/delete/<?php echo $row['bed_id']; ?>" onclick="return confirm('delete?')" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Delete'); ?>" class="btn btn-danger">
