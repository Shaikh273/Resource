						...
						foreach ($blood_bank as $row) : ?>
							...
							<tr>
								...
								<td align="center">
									...
									<a href="<?php echo base_url(); ?>index.php?nurse/manage_blood_bank/edit/<?php echo $row['blood_group_id']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit'); ?>" class="btn btn-primary">
