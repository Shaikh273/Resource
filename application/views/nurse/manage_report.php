						...
						foreach ($birth_reports as $row) : ?>
							...
							<tr>
								...
								<td align="center">
									...
									<a href="<?php echo base_url(); ?>index.php?nurse/manage_report/delete/<?php echo $row['report_id']; ?>" onclick="return confirm('delete?')" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Delete'); ?>" class="btn btn-red">
						...
						foreach ($birth_reports as $row) : ?>
							...
							<tr>
								...
								<td align="center">
									...
									<a href="<?php echo base_url(); ?>index.php?nurse/manage_report/delete/<?php echo $row['report_id']; ?>" onclick="return confirm('delete?')" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Delete'); ?>" class="btn btn-danger">
