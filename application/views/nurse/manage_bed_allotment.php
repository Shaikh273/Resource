				...
				<table cellpadding="0" cellspacing="0" border="0" class="dTable responsive table-hover">
					...
					<thead>
						...
						<tr>
							...
							<th>
								<div><?php echo ('Bed Number'); ?></div>
							</th>

							<th>
								<div><?php echo ('Bed Type'); ?></div>
							</th>
							...
							<th>
								<div><?php echo ('Allotment Date Time'); ?></div>
							</th>

							<th>
								<div><?php echo ('Discharge Date Time'); ?></div>
							</th>
						...
						foreach ($bed_allotment as $row) : ?>
							...
							<tr>
								...
								<td align="center">
									...
									<a href="<?php echo base_url(); ?>index.php?nurse/manage_bed_allotment/edit/<?php echo $row['bed_allotment_id']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit'); ?>" class="btn btn-primary">

										<i class="icon-wrench"></i>

									</a>

									<a href="<?php echo base_url(); ?>index.php?nurse/manage_bed_allotment/delete/<?php echo $row['bed_allotment_id']; ?>" onclick="return confirm('delete?')" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Delete'); ?>" class="btn btn-danger">
